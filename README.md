...
wget https://github.com/yu-mor/tg-ws-proxy-rs/releases/latest/download/tg-ws-proxy-mipsel-unknown-linux-musl.tar.gz -O tg-ws-proxy-mipsel-unknown-linux-musl.tar.gz
